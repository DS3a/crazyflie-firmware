...
// custom tasks
#define ESP_MOTOR_COMMANDER_TASK_PRI 1
...
//custom tasks
#define ESP_MOTOR_COMMANDER_TASK_NAME "ESP_MOTOR_COM"
...
// custom tasks
#define ESP_MOTOR_COMMANDER_TASK_STACKSIZE (configMINIMAL_STACK_SIZE)
